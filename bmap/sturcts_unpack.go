...
func NewStructsUnpack(s any) *StructsUnpack {
	return &StructsUnpack{
		raw:     s,
		value:   strctVal(s),
		TagName: "json",
	}
...
func (s *StructsUnpack) structFields() []reflect.StructField {
	t := s.value.Type()
...
func (s *StructsUnpack) nested(val reflect.Value) interface{} {
	var finalVal interface{}
